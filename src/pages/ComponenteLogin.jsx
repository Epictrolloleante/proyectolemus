...
export default function Login() {
  ...
  const handleSubmit = (event) => {
    ...
    if (data.username !== '' && data.password !== '') {
      fetch('http://serverreyes.ddns.net:8001/api/login', {
        method: 'POST',
        headers: {
        ...
        .catch((error) => {
          ...
          alert('Inicio de sesión fallido. Verifica tus credenciales.'); // Muestra un mensaje de error si la solicitud falla
        });
    } else {
    ...
    <ComponenteLayout Titulo="Inicio de sesion">
      <div class="Loginprincipal">
        ...
        <div class="Logincontenedor">
          ...
          <div class="Logininiciar">
            <p>Login</p>
            <div class="LogindatosIniciar">
              <p>Usuario</p>
